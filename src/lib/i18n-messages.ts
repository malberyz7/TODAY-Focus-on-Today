...
const ru = {
  ...
  holdingDaysSubtitle: "Ты держишься уже {days}",
  ...
  infiniteCardFooter: "Всего {clean} · серия {streak} · рекорд {longest}",
...
const en: Record<keyof typeof ru, string> = {
  ...
  holdingDaysSubtitle: "You have stayed with it for {days}",
  ...
  infiniteCardFooter: "{clean} total · streak {streak} · best {longest}",
